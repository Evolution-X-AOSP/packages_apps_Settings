...
public class QuickMuteParentPreferenceController extends TogglePreferenceController
        implements LifecycleObserver, OnStart, OnStop {

    private final static String SYSTEM_KEY = "volume_button_quick_mute";
    private final static String DELAY_SYSTEM_KEY = "volume_button_quick_mute_delay";

    private PrimarySwitchPreference mPreference;
    private SettingObserver mSettingObserver;

    public QuickMuteParentPreferenceController(Context context, String preferenceKey) {
    ...
    public void updateState(Preference preference) {
        ...
        if (enabled) {
            summary = mContext.getString(R.string.gesture_setting_on) + " ("
                    + Settings.System.getInt(resolver, DELAY_SYSTEM_KEY, 800)
    ...
    public int getSliceHighlightMenuRes() {
        return R.string.menu_key_evolver;
    }
