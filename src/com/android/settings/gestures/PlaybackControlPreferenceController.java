...
public class PlaybackControlPreferenceController extends AbstractPreferenceController
        implements Preference.OnPreferenceChangeListener, PreferenceControllerMixin {

    private static final String KEY = "volume_button_music_control_delay";

    private CustomSeekBarPreference mDelayPref;
    private final Context mContext;

    public PlaybackControlPreferenceController(Context context) {
        super(context);
        mContext = context;
    }
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        final int value = Settings.System.getInt(
                mContext.getContentResolver(), KEY, 500);
