...
import static android.provider.Settings.Secure.PULSE_ON_NEW_TRACKS;
...
public class PulseOnNewTracksPreferenceController extends
    ...
    public boolean setChecked(boolean isChecked) {
        Settings.Secure.putInt(mContext.getContentResolver(), PULSE_ON_NEW_TRACKS, isChecked ? ON : OFF);
        return true;
    }
