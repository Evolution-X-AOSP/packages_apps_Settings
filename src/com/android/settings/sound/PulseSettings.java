...
public class PulseSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mColorPickerPref.setDefaultValue(EvolutionUtils.getThemeAccentColor(getContext()));
        ...
        if (colorMode == COLOR_TYPE_ACCENT) {
            mColorPickerPref.setNewPreviewColor(EvolutionUtils.getThemeAccentColor(getContext()));
        }
