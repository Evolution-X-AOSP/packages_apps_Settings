...
public class IncreasingRingVolumePreference extends Preference implements
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        int rampUpTime = Settings.System.getIntForUser(cr,
                Settings.System.INCREASING_RING_RAMP_UP_TIME, 10, UserHandle.USER_CURRENT);
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromTouch) {
        ...
        if (fromTouch && seekBar == mStartVolumeSeekBar) {
            Settings.System.putFloatForUser(cr,
                    Settings.System.INCREASING_RING_START_VOLUME, (float) progress / 1000F, UserHandle.USER_CURRENT);
            ...
            if (fromTouch) {
                Settings.System.putIntForUser(cr,
                        Settings.System.INCREASING_RING_RAMP_UP_TIME, seconds, UserHandle.USER_CURRENT);
            }
        }
    }
